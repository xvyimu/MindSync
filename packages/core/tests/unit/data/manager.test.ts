...
describe('DataManager', () => {
  ...
  beforeEach(() => {
    ...
    mockHistoryManager = {
      ...
      getUsage: vi.fn().mockResolvedValue({ count: 0, max: 50, nearThreshold: 40, warningLevel: 'ok' }),
      getMaxRecords: vi.fn().mockResolvedValue(50),
      setMaxRecords: vi.fn().mockResolvedValue({ max: 50, dropped: 0 }),
      exportData: vi.fn(),
      importData: vi.fn().mockResolvedValue(undefined),
